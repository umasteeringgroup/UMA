...
- Install Unity 2021.3.45f1 through Unity Hub (EXACT version required)
...
- Verify project opens without errors in Unity 2021.3.45f1
...
4. Test both male and female race variants
...
- Normal generation time: 2-10 seconds per character modification
...
- Character generation: 2-10 seconds per modification
- Addressable builds: 10-20 minutes (NEVER CANCEL)
- Shader compilation: 2-5 minutes (first time in new project)
...
- [ ] Scene Loader menu appears and functions
- [ ] DCS Demo character creation works completely
- [ ] No pink textures or missing materials
- [ ] Console shows no UMA-related errors
- [ ] Both male and female characters generate correctly
- [ ] DNA sliders modify character appearance
- [ ] Wardrobe changes apply correctly
- [ ] Character generation completes within expected time

## Development Environment Requirements

- Unity 2021.3.45f1 (exact version required - critical for compatibility)
