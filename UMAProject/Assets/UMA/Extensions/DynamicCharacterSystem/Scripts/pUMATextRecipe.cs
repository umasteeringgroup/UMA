...
public partial class UMATextRecipe : UMAPackedRecipeBase
{
	...
	//Actually we cant do this here because the recipes maybe in assetbundles and we cant make an IEnumerator here to wait for them to download and update the refrenced UMATextRecipes
	/*public static Dictionary<string, UMATextRecipe> GenerateWardrobeDictionary(List<WardrobeSettings> wardrobeSet, UMAContext context)
	{
    }*/
	...
	//this is used when a DynamicCharacterAvatar avatar is saved using the standard UMA save options. Saves a 'Standard' UMA recipe but with additional Wardrobe recipe data
