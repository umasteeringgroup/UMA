...
namespace UMA
{
    public abstract class DNAEffect
    {
        ...
        public virtual void PreApply(UMAData umaData, DNA dna, float value)
        {
        ...
        public virtual void Apply(UMAData umaData, DNA dna, float value)
        {
            // This is called after PreApply, so we can do the actual application of the effect.
        ...
        public virtual void PostApply(UMAData umaData, DNA dna, float value)
        {
            // This is called after Apply, so we can do any post-processing here.
