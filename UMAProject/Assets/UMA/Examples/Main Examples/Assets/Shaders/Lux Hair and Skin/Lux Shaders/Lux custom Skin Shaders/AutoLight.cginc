...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(unity_WorldToLight, mul(_Object2World, v.vertex)).xyz; TRANSFER_SHADOW(a)
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(unity_WorldToLight, mul(_Object2World, v.vertex)); TRANSFER_SHADOW(a)
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(unity_WorldToLight, mul(_Object2World, v.vertex)).xy; TRANSFER_SHADOW(a)
