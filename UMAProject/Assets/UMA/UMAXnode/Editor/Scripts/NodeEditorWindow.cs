...
namespace UMA.XNodeEditor {
    ...
    public partial class NodeEditorWindow : EditorWindow {
        ...
        public Dictionary<UMA.XNode.NodePort, Rect> portConnectionPoints { get { return _portConnectionPoints; } }
        private Dictionary<UMA.XNode.NodePort, Rect> _portConnectionPoints = new Dictionary<UMA.XNode.NodePort, Rect>();
        ...
        [System.Serializable] private class NodePortReference {
            [SerializeField] private UMA.XNode.Node _node;
            [SerializeField] private string _name;

            public NodePortReference(UMA.XNode.NodePort nodePort) {
                _node = nodePort.node;
                _name = nodePort.fieldName;
            }

            public UMA.XNode.NodePort GetNodePort() {
                if (_node == null) {
                    return null;
                }
        ...
        private void OnEnable() {
            ...
            if (length == _rects.Length) {
                for (int i = 0; i < length; i++) {
                    UMA.XNode.NodePort nodePort = _references[i].GetNodePort();
                    if (nodePort != null)
        ...
        public Dictionary<UMA.XNode.Node, Vector2> nodeSizes { get { return _nodeSizes; } }
        private Dictionary<UMA.XNode.Node, Vector2> _nodeSizes = new Dictionary<UMA.XNode.Node, Vector2>();
        public UMA.XNode.NodeGraph graph;
        ...
        private static void OnSelectionChanged() {
            UMA.XNode.NodeGraph nodeGraph = Selection.activeObject as UMA.XNode.NodeGraph;
        ...
        public void SaveAs() {
            ...
            if (string.IsNullOrEmpty(path)) return;
                ...
                UMA.XNode.NodeGraph existingGraph = AssetDatabase.LoadAssetAtPath<UMA.XNode.NodeGraph>(path);
        ...
        public void SelectNode(UMA.XNode.Node node, bool add) {
            if (add) {
        ...
        public void DeselectNode(UMA.XNode.Node node) {
            List<Object> selection = new List<Object>(Selection.objects);
        ...
        public static bool OnOpen(int instanceID, int line) {
            UMA.XNode.NodeGraph nodeGraph = EditorUtility.InstanceIDToObject(instanceID) as UMA.XNode.NodeGraph;
            if (nodeGraph != null) {
                Open(nodeGraph);
                return true;
            }
        ...
        public static NodeEditorWindow Open(UMA.XNode.NodeGraph graph) {
