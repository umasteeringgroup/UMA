...
namespace UMA.XNodeEditor {
    ...
    public static class NodeEditorPreferences {
        ...
        private static UMA.XNodeEditor.NodeGraphEditor lastEditor;
        ...
        public static Settings GetSettings() {
            if (UMA.XNodeEditor.NodeEditorWindow.current == null) return new Settings();

            if (lastEditor != UMA.XNodeEditor.NodeEditorWindow.current.graphEditor) {
                object[] attribs = UMA.XNodeEditor.NodeEditorWindow.current.graphEditor.GetType().GetCustomAttributes(typeof(UMA.XNodeEditor.NodeGraphEditor.CustomNodeGraphEditorAttribute), true);
                if (attribs.Length == 1) {
                    UMA.XNodeEditor.NodeGraphEditor.CustomNodeGraphEditorAttribute attrib = attribs[0] as UMA.XNodeEditor.NodeGraphEditor.CustomNodeGraphEditorAttribute;
                    lastEditor = UMA.XNodeEditor.NodeEditorWindow.current.graphEditor;
        ...
        public static SettingsProvider CreateXNodeSettingsProvider() {
            SettingsProvider provider = new SettingsProvider("Preferences/Node Editor", SettingsScope.User) {
                guiHandler = (searchContext) => { UMA.XNodeEditor.NodeEditorPreferences.PreferencesGUI(); },
