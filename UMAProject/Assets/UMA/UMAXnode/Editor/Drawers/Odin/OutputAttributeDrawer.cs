...
namespace UMA.XNodeEditor {
	public class OutputAttributeDrawer : OdinAttributeDrawer<UMA.XNode.Node.OutputAttribute> {
		...
		protected override void DrawPropertyLayout(GUIContent label) {
			...
			if (!NodeEditor.inNodeEditor) {
				if (Attribute.backingValue == UMA.XNode.Node.ShowBackingValue.Always || Attribute.backingValue == UMA.XNode.Node.ShowBackingValue.Unconnected && !port.IsConnected)
