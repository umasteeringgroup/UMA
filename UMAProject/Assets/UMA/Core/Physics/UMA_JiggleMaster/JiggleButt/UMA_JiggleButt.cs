...
namespace UMA.Examples
{
    ...
    public class UMA_JiggleButt: MonoBehaviour {
		...
		public float _buttGravity = 0f;
		public float _buttInertia = 0.65f;
		public float _buttMaxJiggleDistance = 0.2f;
		public float _buttTargetDistance = 0.35f;
		public float _buttPositionWeight = 1f;
		public float _buttRotationWeight = 0.15f;
		...
		public void UpdateJiggleBone(JiggleElement jiggler) {
			if (jiggler.Bone.name == "LeftGluteus" || jiggler.Bone.name == "RightGluteus" || jiggler.Bone.name == "GluteusAdjust_L" || jiggler.Bone.name == "GluteusAdjust_R") {
				...
				jiggler.Inertia = _buttInertia;
				jiggler.MaxJiggleDistance = _buttMaxJiggleDistance;
				jiggler.TargetDistance = _buttTargetDistance;
				jiggler.PositionWeight = _buttPositionWeight;
				jiggler.RotationWeight = _buttRotationWeight;
		...
		public void OnCharacterComplete(UMAData umaData)
		{
			...
			ujb._buttInertia = _buttInertia;
			ujb._buttMaxJiggleDistance = _buttMaxJiggleDistance;
			ujb._buttTargetDistance = _buttTargetDistance;
			ujb._buttPositionWeight = _buttPositionWeight;
			ujb._buttRotationWeight = _buttRotationWeight;
