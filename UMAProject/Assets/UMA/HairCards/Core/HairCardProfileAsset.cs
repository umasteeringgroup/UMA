...
namespace UMA.HairCards
{
    ...
    public sealed class HairCardProfileAsset : ScriptableObject
    {
        ...
        [SerializeField, Range(2, 256)] private int samplesPerCard = 12;
        ...
        [SerializeField, Range(0, 255)] private int rootColorSegments;
        ...
        public int SamplesPerCard => Mathf.Clamp(samplesPerCard, 2, 256);
        ...
        {
            maximum = Mathf.Clamp(maximum, 2, 256);
        ...
        public int RootColorSegments => Mathf.Clamp(rootColorSegments, 0, 255);
        ...
        public void ConfigureVertexColors(bool enabled, Color root, Color tip, int solidRootSegments)
        {
            ...
            rootColorSegments = Mathf.Clamp(solidRootSegments, 0, 255);
        }
            ...
            bool generateBackfaces = true)
        {
            ...
            samplesPerCard = Mathf.Clamp(sampleCount, 2, 256);
        ...
        private void OnValidate()
        {
            ...
            samplesPerCard = Mathf.Clamp(samplesPerCard, 2, 256);
            rootColorSegments = Mathf.Clamp(rootColorSegments, 0, 255);
